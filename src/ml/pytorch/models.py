...
class OptimizedCNNCifar(ModelBase):
    def __init__(self, args):
        ...
        self.pool1 = nn.MaxPool2d(2, 2)  # Output: 64x16x16

        self.conv3 = nn.Conv2d(64, 128, kernel_size=3, stride=1, padding=1)  # Output: 128x16x16
        self.conv4 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)  # Output: 128x16x16
        self.pool2 = nn.MaxPool2d(2, 2)  # Output: 128x8x8

        self.fc1 = nn.Linear(128 * 8 * 8, 256)  # Dense layer with 256 neurons
        self.fc2 = nn.Linear(256, 128)  # Dense layer with 128 neurons
        self.fc3 = nn.Linear(128, args.num_classes)  # Final output layer
